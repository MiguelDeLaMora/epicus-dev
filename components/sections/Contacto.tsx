...
const IconPhone = () => (
  <svg viewBox="0 0 24 24" style={{ ...svgStyle, width: 20, height: 20 }}>
...
const IconCheck = () => (
  <svg viewBox="0 0 24 24" style={{ ...svgStyle, width: 40, height: 40 }}>
...
export default function Contacto() {
  ...
  return (
    <div className="relative min-h-[calc(100vh-68px)] flex items-center">
      ...
      {/* ── Fondo oscuro — mitad izquierda ── */}
      <div
        className="absolute top-0 left-0 w-1/2 h-full hidden lg:block"
