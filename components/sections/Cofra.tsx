            ...
            {estructura.map((item) => (
              ...
              >
                <span
                  className={
                    item.active
                      ? "text-[15px] font-medium tracking-[0.04em] text-white"
                      : "text-[15px] font-light tracking-[0.04em] text-white/50"
                  }
                >
                  {item.label}
                </span>
                <span
                  className={
                    item.active
                      ? "text-[11px] tracking-[0.08em] text-blue-light"
                      : "text-[11px] tracking-[0.08em] text-white/30"
                  }
                >
                  {item.sub}
                </span>
