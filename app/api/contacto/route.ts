...
export async function POST(request: Request) {
  try {
    ...
    const { nombre, telefono, correo, interes, presupuesto, mensaje } = body;
    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 32px;">
          ...
          <a 
            href="https://wa.me/528126005642" 
            style="display: inline-block; background: #2563eb; color: white; text-decoration: none; padding: 12px 24px; border-radius: 4px; font-size: 14px; font-weight: 500;"
          >
